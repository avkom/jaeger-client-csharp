...
namespace Jaeger
{
    ...
    public class Configuration
    {
        ...
        /// </summary>
        public static Configuration FromEnv(ILoggerFactory loggerFactory, ISender sender)
        {
            ...
            return new Configuration(GetProperty(JaegerServiceName), loggerFactory)
                ...
                .WithReporter(ReporterConfiguration.FromEnv(loggerFactory, sender))
        ...
        public Configuration WithSender(ISender sender)
        {
            _sender = sender;
            return this;
        }
        ...
        public class ReporterConfiguration
        {
            ...
            public static ReporterConfiguration FromEnv(ILoggerFactory loggerFactory, ISender sender)
            {
                ILogger logger = loggerFactory.CreateLogger<Configuration>();
            ...
            public ReporterConfiguration WithSender(ISender sender)
            {
                Sender = sender;
                return this;
            }
